export const personalities = {
  shouku: {
    ...
    games: ['艾尔登法环', '只狼：影逝二度', '黑神话：悟空', '空洞骑士', '仁王2', '匹诺曹的谎言', '卧龙：苍天陨落', '遗迹2', '堕落之王', '盐与避难所', '死亡细胞', '蔚蓝', 'Hades', '暗黑地牢', 'Blasphemous'],
  ...
  tianliang: {
    ...
    games: ['文明7', '杀戮尖塔', '小丑牌', '群星', '钢铁雄心4', '十字军之王3', '缺氧', '环世界', 'Into the Breach', '冰汽时代', '全面战争：三国', 'XCOM 2', '怪物火车', '王权'],
  ...
  saibo: {
    ...
    games: ['赛博朋克2077', '荒野大镖客：救赎2', '塞尔达传说：王国之泪', '原神', '绯红沙漠', '对马岛之魂', '地平线：西之绝境', '刺客信条：英灵殿', '死亡搁浅', '无人深空', '看火人', '奇异人生', 'Outer Wilds', '死亡搁浅2', 'Subnautica'],
  ...
  tianti: {
    ...
    games: ['CS2', '无畏契约', '英雄联盟', 'DOTA2', 'APEX英雄', '街霸6', '铁拳8', '漫威争锋', '守望先锋2', '彩虹六号：围攻', '永劫无间', '火箭联盟', '王者荣耀', '和平精英'],
  ...
  chanxian: {
    ...
    games: ['异星工厂', '幸福工厂', '环世界', '缺氧', '戴森球计划', 'Shapez', 'Timberborn', '木筏求生', '工人物语', '铁路帝国', 'Mindustry', 'Captain of Industry', 'Banished', '领地人生'],
  ...
  fangkuai: {
    ...
    games: ['我的世界', '泰拉瑞亚', '城市天际线2', '动物园之星', '模拟人生4', '坎巴拉太空计划', 'Besiege', 'Garry\'s Mod', 'Dreams', '创世理想乡', 'Nucleares', '围攻'],
  ...
  yuyin: {
    ...
    games: ['绝地潜兵2', 'REPO', 'VRChat', '双影奇境', '太空杀', '最终幻想14', 'Among Us', '恐鬼症', '致命公司', '胡闹厨房', 'GTFO', '永劫无间'],
  ...
  liusiBa: {
    ...
    games: ['原神', '崩坏：星穹铁道', '赛马娘', '命运冠位指定', '绝区零', '明日方舟', '碧蓝航线', '少女前线2', '阴阳师', '第五人格', '王者荣耀', 'Fate/Grand Order'],
  ...
  laoliu: {
    ...
    games: ['逃离塔科夫', '猎杀：对决', 'DayZ', 'Rust', '暗区突围', '绝地求生', '彩虹六号：围攻', '暗黑地牢', '暗黑地牢2', 'The Finals', '永劫无间'],
  ...
  gandi: {
    ...
    games: ['星际战甲', '流放之路', '失落的方舟', '暗黑破坏神4', '梦幻西游', '魔兽世界', '最终幻想14', '逆水寒', '天涯明月刀', '剑网3', '激战2', '黑色沙漠'],
  ...
  laoe: {
    ...
    games: ['星露谷物语', '欧洲卡车模拟2', '旅行青蛙', '冲就完事模拟器', 'PowerWash Simulator', 'Unpacking', '动物森友会', 'Coffee Talk', 'Stray', 'Gris', 'Florence', 'Alto\'s Odyssey', 'Spiritfarer'],
  ...
  cangshu: {
    ...
    games: ['宝可梦', '怪物猎人：荒野', '怪物猎人：崛起', '艾尔登法环', '暗黑破坏神4', '流放之路', '最终幻想14', '魔兽世界', '命运2', '星际战甲', '无人深空', '英灵神殿', '幻兽帕鲁'],
